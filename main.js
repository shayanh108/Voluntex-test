...
function createOrganizationCard(org, index) {
    ...
    card.innerHTML = `
        <div class="relative overflow-hidden" style="height:200px;${org.imageBg ? `background:${org.imageBg};` : ''}">
            <img src="${org.image}" alt="${org.name}" class="w-full h-full" style="object-fit:${org.imageFit || 'cover'};transition:transform 0.5s ease;${org.imageFit === 'contain' ? 'transform:scale(0.88);' : ''}">
    ...
    const baseScale = org.imageFit === 'contain' ? 0.88 : 1;
